        ...
        static KeywordRepository()
        {
            _keywords = new List<Keyword>
            {
                new Keyword
                {
                    ...
                    {
                        new SecendKeyword{Name = "C#",Id = 1 ,Used = 42},
                        new SecendKeyword{Name = "Java",Id = 2,Used = 21},
                        new SecendKeyword{Name = "Javascript",Id = 3,Used = 32},
                        new SecendKeyword{Name = "Html",Id = 4,Used = 32 },
                        new SecendKeyword{Name = "SQL",Id = 5 ,Used = 32},
                        new SecendKeyword{Name = "Python",Id = 6,Used = 32},
                        new SecendKeyword{Name = "CSS",Id = 7,Used = 32},
                        new SecendKeyword{Name = "PHP",Id = 8,Used = 32}
                    },
                ...
                new Keyword
                {
                    ...
                    SecendKeyword = new List<SecendKeyword>
                    {
                        new SecendKeyword{Name = "VisualStudio",Id = 1,Used = 32 },
                        new SecendKeyword{Name = "eclipse",Id = 2,Used = 32},
                        new SecendKeyword{Name = "IDEA",Id = 3,Used = 32},
                        new SecendKeyword{Name = "Excel",Id = 4 ,Used = 32},
                        new SecendKeyword{Name = "Word",Id = 5 ,Used = 32},
                        new SecendKeyword{Name = "CAD",Id = 6,Used = 32},
                        new SecendKeyword{Name = "Photoshop",Id = 7,Used = 32},
                        new SecendKeyword{Name = "PowerPoint",Id = 8,Used = 32}
                    },
                    SelfDefined = new List<Keyword>{}
                },
                new Keyword
                {
                    ...
                    SecendKeyword = new List<SecendKeyword>
                    {
                        new SecendKeyword{Name = "职场",Id = 1 ,Used = 32},
                        new SecendKeyword{Name = "法律",Id = 2,Used = 32},
                        new SecendKeyword{Name = "财务",Id = 3,Used = 32},
                        new SecendKeyword{Name = "心理",Id = 4 ,Used = 32},
                        new SecendKeyword{Name = "亲子",Id = 5 ,Used = 32},
                        new SecendKeyword{Name = "婚姻家庭",Id = 6,Used = 32}
                    },
                    SelfDefined = new List<Keyword>{}
                },
                new Keyword
                {
                    ...
                    SecendKeyword = new List<SecendKeyword>
                    {
                        new SecendKeyword{Name = "Linux",Id = 1 ,Used = 32},
                        new SecendKeyword{Name = "Windows",Id = 2,Used = 32},
                        new SecendKeyword{Name = "Android",Id = 3,Used = 32},
                        new SecendKeyword{Name = "Unix",Id = 4 ,Used = 32},
                    },
                    SelfDefined = new List<Keyword>{}
                }
            };
